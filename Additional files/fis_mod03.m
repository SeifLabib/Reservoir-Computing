...
% 20190122 AS@HU modified, inserted comments wrt paper
% note: this file implements Fig. 1.a
% z feedback into the reservoir state x aroung line 101
...
scale = 1.0/sqrt(p*N);
M = sprandn(N,N,p)*g*scale;     % soarse rabdin cibbectuvuty
M = full(M);                    % handling sparse matrixes
